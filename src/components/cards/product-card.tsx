...
interface ProductCardProps {
    ...
    /** Front only pour l’instant, mais prêt pour la suite */
...
export function ProductCard({
    ...
    // Si jamais plus tard tu passes des props dynamiques, ça reste à jour
    useEffect(() => {
            ...
            <CardContent className="p-0">
                ...
                >
                    <div className="p-2 pb-0">
                        {/*Icône en haut à droit de la card*/}
                        ...
                        {/*Icône en bas à droit de l'image*/}
                        {/*<div className="relative aspect-[5/6] w-full overflow-hidden rounded-xl bg-muted">*/}
                        {/*    {imageUrl ? (*/}
                        {/*        <img*/}
                        {/*            src={imageUrl}*/}
                        ...
                        {/*    ) : (*/}
                        {/*        <div*/}
                        {/*            className="flex h-full w-full items-center justify-center text-[11px] text-muted-foreground">*/}
                        {/*            Photo à venir*/}
                        {/*        </div>*/}
                        {/*    )}*/}
...
// icone en bas à droite de la card
